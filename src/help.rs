...
pub fn help() {
    printtr!("Usage:");
    printtr!("    qp");
    printtr!("    qp <operation> [...]");
    printtr!("    qp <package(s)>");
    println!();
    printtr!("Pacman operations:");
    printtr!("    qp {-h --help}");
    printtr!("    qp {-V --version}");
    printtr!("    qp {-D --database}    <options> <package(s)>");
    printtr!("    qp {-F --files}       [options] [package(s)]");
    printtr!("    qp {-Q --query}       [options] [package(s)]");
    printtr!("    qp {-R --remove}      [options] <package(s)>");
    printtr!("    qp {-S --sync}        [options] [package(s)]");
    printtr!("    qp {-T --deptest}     [options] [package(s)]");
    printtr!("    qp {-U --upgrade}     [options] [file(s)]");
    println!();
    printtr!("New operations:");
    printtr!("    qp {-P --show}        [options]");
    printtr!("    qp {-G --getpkgbuild} [package(s)]");
    printtr!("    qp {-B --build}       [dir(s)]");
    printtr!("    qp {-L --repoctl}     List overlay repositories");
    println!();
    printtr!("If no arguments are provided 'qp -Syu' will be performed");
    println!();
    ...
    println!();
    printtr!("Manual package management:");
    printtr!("       --mark-installed <pkg> [ver]   Register a package as manually installed");
    printtr!("       --mark-uninstalled <pkg>       Register a package as manually uninstalled");
    printtr!("       --list-manual                  List manually tracked packages");
    printtr!("       --mark-provides <list>         Comma-separated provides for --mark-installed");
    printtr!("       --mark-depends <list>          Comma-separated depends for --mark-installed");
    printtr!("       --auto-provides                Auto-detect .so provides from installed files");
    println!();
    printtr!("New options:");
    ...
    printtr!("    --mode      <mode>     Sets where qp looks for targets");
    printtr!(
